...
ASSERT_TRUE(regs
.StepIfSignalHandler(0x8000, elf_.
...
EXPECT_EQ(0x460U, regs.

sp()

);
EXPECT_EQ(0x470U, regs.
...
ASSERT_TRUE(regs
.StepIfSignalHandler(0x4100, elf_.
...
EXPECT_EQ(0x80U, regs.

sp()

);
EXPECT_EQ(0xf0U, regs.
...
EXPECT_EQ(0xc0U, regs.

sp()

);
EXPECT_EQ(0x130U, regs.
...
ASSERT_TRUE(regs
.StepIfSignalHandler(0x7000, elf_.
...
EXPECT_EQ(0x140U, regs.

sp()

);
EXPECT_EQ(0x150U, regs.
...
EXPECT_EQ(0x220U, regs.

sp()

);
EXPECT_EQ(0x040U, regs.
...
EXPECT_EQ(0x350U, regs.

sp()

);
EXPECT_EQ(0x170U, regs.
