...
WriteDescriptor32(0xf800, 0);
jit_debug_.reset(new
JitDebug(process_memory_)
);
jit_debug_->
SetArch(ARCH_ARM);
...
jit_debug_.reset(new
JitDebug(process_memory_, libs
));
jit_debug_->
SetArch(ARCH_ARM);
EXPECT_TRUE(jit_debug_
->
GetElf(maps_
.
