...
this->memory_.SetMemory(0x2000, std::vector <uint8_t>{
i});
dwarf_loc_regs_t loc_regs;

ASSERT_FALSE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x2000, 0x2001, &loc_regs));
ASSERT_EQ(DWARF_ERROR_ILLEGAL_VALUE,
this->cfa_->

LastErrorCode()

);
ASSERT_EQ(0x2001U, this->dmem_->
...
ASSERT_EQ(0x2002U, this->dmem_->

cur_offset()

);
ASSERT_EQ(1U, loc_regs.
...
ASSERT_EQ(DWARF_LOCATION_OFFSET, location
->second.type);
...
this->memory_.SetMemory(0x2100, std::vector <uint8_t>{
0x83, 0x84, 0x01});
loc_regs.
...
this->memory_.SetMemory(0x1500, std::vector <uint8_t>{
0x05, 0x81, 0x01, 0x82, 0x12});

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x1500, 0x1505, &loc_regs));
ASSERT_EQ(0x1505U, this->dmem_->
...
ASSERT_FALSE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x2000, 0x2001, &loc_regs));
ASSERT_EQ(DWARF_ERROR_ILLEGAL_STATE,
this->cfa_->
...
cie_loc_regs[2] = {
.
type = DWARF_LOCATION_REGISTER,
.
values = {0, 0}
};
this->cfa_->
set_cie_loc_regs(&cie_loc_regs);
this->memory_.SetMemory(0x3000, std::vector <uint8_t>{
0x82, 0x04, 0xc2});

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x3000, 0x3003, &loc_regs));
ASSERT_EQ(0x3003U, this->dmem_->
...
ASSERT_EQ(DWARF_LOCATION_REGISTER, location
->second.type);
...
this->memory_.SetMemory(0x4000, std::vector <uint8_t>{
0x06, 0x08});
dwarf_loc_regs_t loc_regs;
...
this->memory_.SetMemory(0x5000, std::vector <uint8_t>{
0x05, 0x82, 0x02, 0x04, 0x06, 0x82, 0x02});
dwarf_loc_regs_t cie_loc_regs;
cie_loc_regs[258] = {
.
type = DWARF_LOCATION_REGISTER,
...
ASSERT_EQ(0x51 + sizeof(TypeParam), this->dmem_->
...
cur_address_str[cur_address_str.
...
this->memory_.SetMemory(0x200, std::vector <uint8_t>{
0x02, 0x04});
dwarf_loc_regs_t loc_regs;

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x200, 0x202, &loc_regs));
ASSERT_EQ(0x202U, this->dmem_->

cur_offset()

);
ASSERT_EQ(this->fde_.pc_start + 0x10, this->cfa_->
...
this->memory_.SetMemory(0x600, std::vector <uint8_t>{
0x03, 0x04, 0x03});
dwarf_loc_regs_t loc_regs;

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x600, 0x603, &loc_regs));
ASSERT_EQ(0x603U, this->dmem_->

cur_offset()

);
ASSERT_EQ(this->fde_.pc_start + 0xc10U, this->cfa_->
...
this->memory_.SetMemory(0x500, std::vector <uint8_t>{
0x04, 0x04, 0x03, 0x02, 0x01});
dwarf_loc_regs_t loc_regs;

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x500, 0x505, &loc_regs));
ASSERT_EQ(0x505U, this->dmem_->

cur_offset()

);
ASSERT_EQ(this->fde_.pc_start + 0x4080c10, this->cfa_->
...
this->memory_.SetMemory(0x100, std::vector <uint8_t>{
0x08, 0x7f});
dwarf_loc_regs_t loc_regs;
...
this->memory_.SetMemory(0x4300, std::vector <uint8_t>{
0x09, 0xff, 0x01, 0xff, 0x03});

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x4300, 0x4305, &loc_regs));
ASSERT_EQ(0x4305U, this->dmem_->
...
ASSERT_EQ(0x2005U, this->dmem_->

cur_offset()

);
ASSERT_EQ(2U, loc_regs.
...
0x6000, std::vector <uint8_t>{
0x0a, 0x85, 0x02, 0x0a, 0x86, 0x04, 0x0a, 0x87, 0x01, 0x0a, 0x89,
...
ASSERT_EQ(0x600cU, this->dmem_->

cur_offset()

);
ASSERT_EQ(4U, loc_regs.
...
ASSERT_EQ(0x600dU, this->dmem_->

cur_offset()

);
ASSERT_EQ(3U, loc_regs.
...
ASSERT_EQ(DWARF_LOCATION_REGISTER, loc_regs[CFA_REG]
.type);
...
.type);
ASSERT_EQ(3U, loc_regs[CFA_REG].values[0]);
ASSERT_EQ(static_cast<TypeParam>(-80), static_cast
<TypeParam>(loc_regs[CFA_REG]
.values[1]));
...
ASSERT_EQ(DWARF_LOCATION_VAL_EXPRESSION, loc_regs[CFA_REG]
.type);
...
ASSERT_EQ(DWARF_LOCATION_EXPRESSION, location
->second.type);
ASSERT_EQ(2U, location->second.values[0]);
...
ASSERT_EQ(DWARF_LOCATION_VAL_OFFSET, location
->second.type);
...
this->memory_.SetMemory(0x400, std::vector <uint8_t>{
0x14, 0xa2, 0x02, 0xb4, 0x05});

ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.pc_start, 0x400, 0x405, &loc_regs));
ASSERT_EQ(0x405U, this->dmem_->
...
ASSERT_EQ(DWARF_LOCATION_VAL_EXPRESSION, location
->second.type);
ASSERT_EQ(2U, location->second.values[0]);
ASSERT_EQ(0x105U, location->second.values[1]);
