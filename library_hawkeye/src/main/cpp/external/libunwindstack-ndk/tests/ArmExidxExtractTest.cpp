...
namespace unwindstack {
    ...
    ASSERT_FALSE(exidx_
    ->ExtractEntryData(0x1001));
    ASSERT_EQ(ARM_STATUS_INVALID_ALIGNMENT, exidx_
    ->
...
ASSERT_FALSE(exidx_
->ExtractEntryData(0x4000));
ASSERT_EQ(ARM_STATUS_INVALID_PERSONALITY, exidx_
->
...
ASSERT_FALSE(exidx_
->ExtractEntryData(0x5000));
ASSERT_EQ(ARM_STATUS_READ_FAILED, exidx_
->

status()

);
EXPECT_EQ(0x5004U, exidx_->
...
ASSERT_FALSE(exidx_
->ExtractEntryData(0x5000));
ASSERT_EQ(ARM_STATUS_MALFORMED, exidx_
->
