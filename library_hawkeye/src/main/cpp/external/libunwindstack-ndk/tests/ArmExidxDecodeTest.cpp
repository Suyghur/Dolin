...
ASSERT_EQ(ARM_STATUS_NO_UNWIND, exidx_
->
...
ASSERT_EQ(0x29U, exidx_->

cfa()

);

ASSERT_EQ(0x20U, (*exidx_->

regs()

)[4]);
ASSERT_EQ(0x21U, (*exidx_->

regs()

)[5]);
ASSERT_EQ(0x22U, (*exidx_->

regs()

)[6]);
ASSERT_EQ(0x23U, (*exidx_->

regs()

)[7]);
ASSERT_EQ(0x24U, (*exidx_->

regs()

)[8]);
ASSERT_EQ(0x25U, (*exidx_->

regs()

)[9]);
ASSERT_EQ(0x26U, (*exidx_->

regs()

)[10]);
ASSERT_EQ(0x27U, (*exidx_->

regs()

)[11]);
ASSERT_EQ(0x28U, (*exidx_->
...
ASSERT_EQ(0x2aU, (*exidx_->

regs()

)[14]);
ASSERT_EQ(0x2bU, (*exidx_->
...
ASSERT_EQ(0x10040U, exidx_->

cfa()

);
ASSERT_EQ(0x11U, (*exidx_->
...
ASSERT_EQ(ARM_STATUS_RESERVED, exidx_
->
...
ASSERT_EQ(0x30U, (*exidx_->

regs()

)[5]);
ASSERT_EQ(0x40U, (*exidx_->

regs()

)[6]);
ASSERT_EQ(0x50U, (*exidx_->
...
ASSERT_EQ(0x10034U, exidx_->

cfa()

);
ASSERT_EQ(0x41U, (*exidx_->

regs()

)[4]);
ASSERT_EQ(0x51U, (*exidx_->

regs()

)[5]);
ASSERT_EQ(0x61U, (*exidx_->

regs()

)[6]);
ASSERT_EQ(0x71U, (*exidx_->

regs()

)[7]);
ASSERT_EQ(0x81U, (*exidx_->

regs()

)[8]);
ASSERT_EQ(0x91U, (*exidx_->

regs()

)[9]);
ASSERT_EQ(0xa1U, (*exidx_->

regs()

)[10]);
ASSERT_EQ(0xb1U, (*exidx_->
...
ASSERT_EQ(0x10008U, exidx_->

cfa()

);
ASSERT_EQ(0x12U, (*exidx_->
...
ASSERT_EQ(0x1001cU, exidx_->

cfa()

);
ASSERT_EQ(0x1U, (*exidx_->

regs()

)[4]);
ASSERT_EQ(0x2U, (*exidx_->

regs()

)[5]);
ASSERT_EQ(0x3U, (*exidx_->

regs()

)[6]);
ASSERT_EQ(0x4U, (*exidx_->

regs()

)[7]);
ASSERT_EQ(0x5U, (*exidx_->
...
ASSERT_EQ(0x3aU, (*exidx_->

regs()

)[6]);
ASSERT_EQ(0x4aU, (*exidx_->

regs()

)[7]);
ASSERT_EQ(0x5aU, (*exidx_->

regs()

)[8]);
ASSERT_EQ(0x6aU, (*exidx_->

regs()

)[9]);
ASSERT_EQ(0x7aU, (*exidx_->

regs()

)[10]);
ASSERT_EQ(0x8aU, (*exidx_->

regs()

)[11]);
ASSERT_EQ(0x9aU, (*exidx_->
...
ASSERT_EQ(0x10000U, exidx_->

cfa()

);
ASSERT_EQ(ARM_STATUS_FINISH, exidx_
->
...
ASSERT_EQ(ARM_STATUS_SPARE, exidx_
->
...
ASSERT_EQ(0x65U, (*exidx_->

regs()

)[0]);
ASSERT_EQ(0x54U, (*exidx_->

regs()

)[1]);
ASSERT_EQ(0x43U, (*exidx_->

regs()

)[2]);
ASSERT_EQ(0x32U, (*exidx_->
...
ASSERT_EQ(ARM_STATUS_TRUNCATED, exidx_
->
...
ASSERT_NE(ARM_STATUS_TRUNCATED, exidx_
->
...
<< "x y = 0x" << std::hex << x << " 0x" <<
y;
ASSERT_NE(ARM_STATUS_READ_FAILED, exidx_
->
