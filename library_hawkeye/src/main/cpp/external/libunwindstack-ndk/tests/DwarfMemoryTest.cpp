...
namespace unwindstack {
    ...
    memory_.SetMemory(0, std::vector <uint8_t> {
    0x10, 0x18, 0xff, 0xfe
}
);

uint8_t byte;
ASSERT_TRUE(dwarf_mem_
->
ReadBytes(&byte,
1));
...
ASSERT_TRUE(dwarf_mem_
->
ReadSigned<int8_t>(&value)
);
ASSERT_EQ(static_cast<int8_t>(-10), static_cast
<int8_t>(value)
);
ASSERT_TRUE(dwarf_mem_
->
...
ASSERT_EQ(static_cast<int8_t>(200), static_cast
<int8_t>(value)
);
...
ASSERT_TRUE(dwarf_mem_
->
ReadSigned<int16_t>(&value)
);
ASSERT_EQ(static_cast<int16_t>(-1000), static_cast
<int16_t>(value)
);
ASSERT_TRUE(dwarf_mem_
->
...
ASSERT_EQ(static_cast<int16_t>(50100), static_cast
<int16_t>(value)
);
...
ASSERT_TRUE(dwarf_mem_
->
ReadSigned<int32_t>(&value)
);
ASSERT_EQ(static_cast<int32_t>(-1000000000), static_cast
<int32_t>(value)
);
ASSERT_TRUE(dwarf_mem_
->
...
ASSERT_EQ(static_cast<int32_t>(3000000000), static_cast
<int32_t>(value)
);
...
ASSERT_TRUE(dwarf_mem_
->
ReadSigned<int64_t>(&value)
);
ASSERT_EQ(static_cast<int64_t>(-2000000000000), static_cast
<int64_t>(value)
);
ASSERT_TRUE(dwarf_mem_
->
...
ASSERT_EQ(static_cast<int64_t>(5000000000000), static_cast
<int64_t>(value)
);
}
...
memory_.SetMemory(0, std::vector <uint8_t>{
0x01, 0x80, 0x24, 0xff, 0xc3, 0xff, 0x7f});
...
memory_.SetMemory(0, std::vector <uint8_t>{
0x06, 0x40, 0x82, 0x34, 0x89, 0x64, 0xf9, 0xc3, 0x8f,
...
ASSERT_EQ(2U, dwarf_mem_->

cur_offset()

);
ASSERT_EQ(0xffffffffffffffc0ULL, static_cast
<uint64_t>(value)
);
...
ASSERT_EQ(6U, dwarf_mem_->

cur_offset()

);
ASSERT_EQ(0xfffffffffffff209ULL, static_cast
<uint64_t>(value)
);
...
ASSERT_EQ(14U, dwarf_mem_->

cur_offset()

);
ASSERT_EQ(0xfffffffffbfde1bfULL, static_cast
<uint64_t>(value)
);
}
...
uint64_t value = 100;
ASSERT_FALSE(dwarf_mem_
->ReadEncodedValue<uint32_t>(0x00, &value));
...
uint64_t value = 100;
ASSERT_FALSE(dwarf_mem_
->ReadEncodedValue<uint64_t>(0x00, &value));

memory_.SetData64(0, 0x12345678f1f2f3f4ULL);

ASSERT_TRUE(dwarf_mem_
->ReadEncodedValue<uint64_t>(0x00, &value));
ASSERT_EQ(8U, dwarf_mem_->
...
ASSERT_FALSE(dwarf_mem_
->ReadEncodedValue<uint32_t>(0x50, &value));
...
dwarf_mem_->set_cur_offset(1);
ASSERT_FALSE(dwarf_mem_
->ReadEncodedValue<uint64_t>(0x50, &value));

memory_.SetData64(8, 0x12345678f1f2f3f4ULL);

ASSERT_TRUE(dwarf_mem_
->ReadEncodedValue<uint64_t>(0x50, &value));
ASSERT_EQ(16U, dwarf_mem_->
